...
- Title: FASHION FILM | Shot on Sony A7iii Slog2 2021
- Creator's name: Felix Chacon (Felix on YouTube)
- Link to the video: https://www.youtube.com/watch?v=s1x4u5QBbXM
- Description: Video used for background in the index.html page.
- Things that I (Jesse Proulx) adjusted from the video in Adobe Premiere Pro:
  1. Edited the bests shots of the model
